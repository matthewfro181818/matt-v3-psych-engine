...
class ChartingState extends MusicBeatState implements PsychUIEventHandler.PsychUIEvent
{
	...
	var lastBeatHit:Int = 0;package states.editors;
...
class AttachedFlxText extends FlxText
{
	...
	function addSectionTab()
	{
		...
		var swapSectionButton:PsychUIButton = new PsychUIButton(10, check_notesSec.y + 40, "Swap section", function()
		{
			for (i in 0..._song.notes[curSec].sectionNotes.length)
			{
				var note:Array<Dynamic> = _song.notes[curSec].sectionNotes[i];
	...
	function addSongTab()
	{
		...
		var stepperKeyCount:PsychUINumericStepper = new PsychUINumericStepper(100, stepperSpeed.y, 1, 4, 1, 9, 0);
		if (_song.keyCount != null)
			stepperKeyCount.value = _song.keyCount;
		stepperKeyCount.name = 'song_keyCount';
		blockPressWhileTypingOnStepper.push(stepperKeyCount);
